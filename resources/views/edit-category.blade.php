        ...
        <div class="container">
            ...
            <form action="/save-category" method="post" style="margin-top: 40px" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-4">
                    ...
                    <input name="slug" type="text" class="form-control" id="validationCustom02" value="" required>
                    <div class="invalid-feedback">
                        Please enter slug.
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <input name="count" type="text" class="form-control" id="validationCustom02" value="" required>
                    <div class="invalid-feedback">
                        Please enter count.
                    </div>
                </div>
